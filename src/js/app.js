...
function render(variables = {}) {
  console.log("These are the current variables: ", variables); // Imprimir en la consola para depuración

  let cover = `<div class="cover"><img src="${variables.background ||
    "https://via.placeholder.com/150"}" /></div>`;
  if (!variables.includeCover) cover = "<div class='cover'></div>";

  const fullName = `${variables.name || "John"} ${variables.lastName || "Doe"}`;
